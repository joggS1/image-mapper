...
var fsm_js_1 = require("./fsm.js");
var events_js_1 = require("./events.js");
var onChangeProxy_js_1 = require("./onChangeProxy.js");
var polygon_js_1 = require("./polygon.js");
var rect_js_1 = require("./rect.js");
var circle_js_1 = require("./circle.js");
var ellipse_js_1 = require("./ellipse.js");
...
var Editor = /** @class */ (function () {
    function Editor(svgEl, options, style) {
        ...
        this.style = deepMerge((0, style_js_1.getDefaultStyle)(), style);
        this.fsmService = (0, fsm_js_1.default)(this).start();
        this.svg = svgEl;
        if (typeof svgEl === 'string') {
            this.svg = globals_js_1.doc.getElementById(svgEl);
            if (!this.svg) {
                this.svg = globals_js_1.doc.createElementNS(constants_js_1.SVG_NS, 'svg');
                ...
                window.addEventListener('load', function load() {
                    globals_js_1.doc.body.appendChild(svg_1);
                }, { once: true });
            }
        }
        ...
        this.cgroup = globals_js_1.doc.createElementNS(constants_js_1.SVG_NS, 'g');
        this.hgroup = globals_js_1.doc.createElementNS(constants_js_1.SVG_NS, 'g');
        this.svg.appendChild(this.cgroup);
        this.svg.appendChild(this.hgroup);
        this._cacheElementMapping = (0, onChangeProxy_js_1.onChange)({}, function (prop, newComponent, prevComponent) {
            if (newComponent) {
                if (newComponent instanceof handle_js_1.Handle) {
                ...
                if (prevComponent instanceof handle_js_1.Handle) {
    ...
    Editor.prototype.loadImage = function (path, width, height) {
        var _a;
        var image = globals_js_1.doc.createElementNS(constants_js_1.SVG_NS, 'image');
        image.setAttributeNS(constants_js_1.XLINK_NS, 'href', path);
    ...
    Editor.prototype.on = function (eventTypes, handler) {
        (0, events_js_1.addEventListeners)(this.svg, eventTypes, handler);
        return this;
    };
    ;
    Editor.prototype.off = function (eventTypes, handler) {
        (0, events_js_1.removeEventListeners)(this.svg, eventTypes, handler);
        return this;
    };
    ;
    ...
    Editor.prototype.export = function (escape) {
        var data = {
            ...
            components: Object.entries(this._cacheElementMapping)
                ...
                return !(component instanceof handle_js_1.Handle);
            })
                .map(function (_a) {
                var id = _a[0], component = _a[1];
                return ({
    ...
    Editor.prototype.createRectangle = function (dim, id) {
        ...
        return this.registerComponent(new rect_js_1.Rectangle(this, x, y, width, height).setStyle(this.style).setDataAttributes(attributes), id);
    };
    ;
    Editor.prototype.createCircle = function (dim, id) {
        var x = dim.x, y = dim.y, width = dim.width, height = dim.height, attributes = __rest(dim, ["x", "y", "width", "height"]);
        return this.registerComponent(new circle_js_1.Circle(this, x, y, width, height).setStyle(this.style).setDataAttributes(attributes), id);
    };
    ;
    Editor.prototype.createEllipse = function (dim, id) {
        var x = dim.x, y = dim.y, width = dim.width, height = dim.height, attributes = __rest(dim, ["x", "y", "width", "height"]);
        return this.registerComponent(new ellipse_js_1.Ellipse(this, x, y, width, height).setStyle(this.style).setDataAttributes(attributes), id);
    };
    ;
    Editor.prototype.createPolygon = function (data, id) {
        var points = data.points, attributes = __rest(data, ["points"]);
        return this.registerComponent(new polygon_js_1.Polygon(this, points).setStyle(this.style).setDataAttributes(attributes), id);
    };
    ;
    Editor.prototype.registerComponent = function (component, id) {
        if (component instanceof handle_js_1.Handle) {
...
var addEditorListeners = function (editor) {
    ...
    (0, events_js_1.addEventListeners)(editor.svg, 'mousedown touchstart', function (e) {
        var _a;
    ...
    (0, events_js_1.addEventListeners)(editor.svg, 'mouseup touchend mouseleave touchleave', function (e) {
        e.preventDefault(); // avoid both mouse and touch event on devices firing both
        editor.fsmService.send({
            type: 'MT_UP',
        });
    ...
    (0, events_js_1.addEventListeners)(editor.svg, 'mousemove touchmove', function (e) {
        var _a;
        var touchBCR = (_a = editor.svg) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect();
        var touch = e.targetTouches && e.targetTouches[0];
        editor.fsmService.send({
    ...
    (0, events_js_1.addEventListeners)(globals_js_1.root.window, 'keydown', function (e) {
        switch (e.key) {
            case 'Escape':
...
var addViewListeners = function (view) {
    (0, events_js_1.addEventListeners)(view.cgroup, 'click touchstart', function (e) {
