...
declare const editor: (svgEl: string | SVGSVGElement, options?: import("./types").EditorOptions, style?: {}) => {
    width: number;
    height: number;
    svg: SVGSVGElement;
    style: object;
...
declare const view: (svgEl: string | SVGSVGElement, options?: import("./types").EditorOptions, style?: {}) => {
    width: number;
    height: number;
    svg: SVGSVGElement;
    style: object;
...
export { editor, view, PolygonOptions, FigureOptions, };
